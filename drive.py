# A script that you can use to drive the car autonomously,
# once your deep neural network model is trianed
...
def telemetry(sid, data):
    if data:
        ...
        # resize image array to 60, 200
        image_pre = np.asarray(image)

        # TODO call preprocess image
